...
# Add settings
Irssi::settings_add_str("recentdepart", "recdep_channels", '*');
Irssi::settings_add_int("recentdepart", "recdep_period", 600);
Irssi::settings_add_int("recentdepart", "recdep_rejoin", 120);
Irssi::settings_add_int("recentdepart", "recdep_nickperiod", 600);
Irssi::settings_add_bool("recentdepart", "recdep_use_hideshow", 0);
on_setup_changed();
